...
Unfortulately swapi.co is not maintained anymore, and the service is currently down. This is an "unofficial" for of SWAPI that will be supported going forward.
